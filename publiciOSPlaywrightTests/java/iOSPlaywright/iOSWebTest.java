...
//****** We need to set the myDUT to the device ID ******
	...
	private static String host = "signet";
	private static String myDUT = "00008110-000905E136D0401E";
	    ...
	    public static void main(String[] args) throws MalformedURLException, IOException {
			...
			String testName = "perfecto-Playwright-iOSBeta";
			...
			Playwright playwright = Playwright.create();
	            ...
	            capabilities.addProperty("platformName", "iOS");
